...
exports.html = function(req, res, files, next, dir, showUp, icons){
  fs.readFile(__dirname + '/../client/directory.html', 'utf8', function(err, str){
    if (err) return next(err);
    fs.readFile(__dirname + '/../client/style.css', 'utf8', function(err, style){
      if (err) return next(err);
...
function load(icon) {
  ...
  return cache[icon] = fs.readFileSync(__dirname + '/../client/icons/' + icon, 'base64');
}
